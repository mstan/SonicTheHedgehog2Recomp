...
REPO_NAME="SonicTheHedgehog2Recomp"      # GitHub repo / zip basename
APP_NAME="Sonic the Hedgehog 2"        # .app display name (may contain spaces)
TARGET="SonicTheHedgehog2Recomp"            # cmake target == built binary filename in build-mac/
SYSTEM="genesis"            # nes | snes | genesis | vb | psx
VERSION="v0.3.0-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Sonic the Hedgehog 2 (Genesis) .bin/.md dump"        # human description of the ROM the user must supply
# ==============================================

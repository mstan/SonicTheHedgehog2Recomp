...
static int s2_instruction_hook(uint32_t pc)
{
    ...
    case 0x213E: case 0x1C6F6: case 0x1C644: case 0x1BA14: case 0x1BA1C:
...
const GameSpec g_game_spec = {
    ...
    .netplay_config_image   = s2_netplay_config_image,
    .netplay_config_adopt   = s2_netplay_config_adopt,
    .rb_state_save          = s2_runtime_rb_save,
    .rb_state_load          = s2_runtime_rb_load,
